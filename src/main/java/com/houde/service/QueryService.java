...
import com.houde.bean.CommandContent;
import com.houde.bean.Message;
import com.houde.dao.CommandDao;
import com.houde.dao.MessageDao;
import com.houde.util.Iconst;
...
public class QueryService {
    public List<Message> queryMessageList(String command, String description) {
        ...
        // 查询并返回结果
        return messageDao.queryMsgListMybatis(command,description);
    }
